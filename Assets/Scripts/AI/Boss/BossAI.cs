...
public class BossAI : MonoBehaviour
{
    ...
    public GameObject healerMinionPrefab; // Prefab du minion guérisseur
    public GameObject fireWallPrefab; // Prefab du mur de feu
    ...
    void EnterPhase2()
    {
        ...
        SpawnMinions(3, minionPrefab); // Faire apparaître 3 minions
    }
    ...
    void EnterPhase3()
    {
        ...
        SpawnMinions(5, minionPrefab); // Faire apparaître 5 minions
    ...
    void SpawnMinions(int numberOfMinions, GameObject minionPrefab)
    {
